            ...
            switch(choice)
            {
                ...
                case 7: // Team information.
                    ...
                    for(int32_t i = 0;i < 20;i++)
                    {
                        ...
                        if(i == 19) 
                        {
                            printf("Error: There is no team called \"%s\".\n",team_search);
                        }
                    }
...
void calculate_the_data(FILE* record,sTeam* team_data,char* the_most_scoring_gap)
{
    ...
    while(fgets(nowData,512,record) != NULL)
    {
        ...
        // %*[^,] means to ignore the data before the character ,
